...
?>
<link rel="stylesheet" href="../app/css/veterinario/agregar_historial_clinico.css">
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p>Complete la información para agregar un nuevo registro al historial clínico de la mascota</p>
        </div>
        <div class="form-body">
            <!-- Alerta informativa -->
            <div class="info-alert">
                <i class="fas fa-info-circle"></i>
                <span>Los campos marcados con <strong style="color:#e74c3c;">*</strong> son obligatorios. La fecha se registrará automáticamente.</span>
            </div>
            ...
            <div class="mascota-info" id="mascotaInfo">
                ...
                <div class="mascota-datos">
                    ...
                    <p><i class="fas fa-user"></i> Propietario: <strong id="clienteNombre"><?= htmlspecialchars(ucfirst($mascota->nombre_cliente)) ?></strong> | <i class="fas fa-id-card"></i> <span id="clienteCedula"><?= htmlspecialchars($mascota->cedula) ?></span></p>
                </div>
            </div>

            <form id="registroHistorialForm" method="POST" action="../controladores/veterinario/agregar_historial_clinico.php">
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="number" id="peso" name="peso" min="0.1" step="0.1" placeholder="Ej: 24.5">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="sintomas" name="sintomas" rows="3" placeholder="Describa los síntomas presentados por el paciente..."></textarea>
                </div>

                <div class="form-group">
                    <label class="required"><i class="fas fa-stethoscope"></i> Diagnóstico</label>
                    <textarea id="diagnostico" name="diagnostico" rows="3" placeholder="Diagnóstico principal de la consulta..." required></textarea>
                </div>

                <div class="form-group">
                    <label><i class="fas fa-prescription-bottle"></i> Tratamiento</label>
                    <textarea id="tratamiento" name="tratamiento" rows="3" placeholder="Tratamiento indicado (medicamentos, dosis, duración)..."></textarea>
                </div>

                <div class="form-group">
                    <label><i class="fas fa-comment-dots"></i> Observaciones</label>
                    <textarea id="observaciones" name="observaciones" rows="2" placeholder="Observaciones adicionales, recomendaciones, seguimiento..."></textarea>
                </div>
                ...
                <div class="form-buttons">
                    ...
                    <button type="button" class="btn-secondary" onclick="window.location.href='historial_clinico_mascota.php?id_mascota=<?= urlencode(Crypto::encrypt($id_mascota)) ?>&id_cita=<?= urlencode(Crypto::encrypt($id_cita)) ?>'">
    ...
    <div style="margin-top: 20px; text-align: center; background: white; border-radius: 20px; padding: 15px; border: 1px solid #eef2f8;">
        ...
        <span style="font-size: 0.8rem; color: #5f7f8f;"> El registro se agregará al historial clínico de la mascota con la fecha actual</span>
    </div>
</div>

<script src="../app/js/veterinario/agregar_historial_clinico.js"></script>
